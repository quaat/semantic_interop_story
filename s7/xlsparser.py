...
class XLSParser:
    ...
    def get(self):    
        wb_obj = load_workbook(self.xls_model["workbook"], data_only=True)
        ...
        for d in self.xls_model["data"]:
            ...
            cellRange = dataRange.intersection(CellRange(self.xls_model["data"][d]["range"]))
            for cell in product(        
